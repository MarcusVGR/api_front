...
router.get('/pessoas/:alunoId/matricula/:matriculaId', PessoasController.pegaUmaMatricula)
router.post('/pessoas/:alunoId/matricula', PessoasController.criaMatricula)
router.put('/pessoas/:alunoId/matricula/:matriculaId', PessoasController.atualizaMatricula)
router.delete('/pessoas/:alunoId/matricula/:matriculaId', PessoasController.apagaMatricula)
